...
export const StudyModesSection = () => {
  return (
    <main className="flex flex-col items-center justify-start py-10 text-black px-4">
      <h1 className="text-5xl md:text-5xl font-bold text-center mb-4">How do you want to study?</h1>

      <p className="text-center text-lg md:text-xl max-w-2xl mb-8">
        Master whatever you’re learning with Mimir’s interactive flashcards, practice tests and
        study activities.
      </p>
